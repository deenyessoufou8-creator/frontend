cat > /home/claude/frontend/src/pages/Connexion.jsx << 'EOF'
...
EOF
cd /home/claude/frontend && npx esbuild src/pages/Connexion.jsx --bundle --loader:.jsx=jsx --outfile=/dev/null --external:react --external:react-router-dom 2>&1
Sortie


  ../../../dev/null  7.0kb

⚡ Done in 7mscat > /home/claude/frontend/src/pages/Connexion.jsx << 'EOF'
import { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import StatsBadge from '../components/StatsBadge';
